...
export class HomeComponent implements OnInit{
  ...
  callDetail(event: any) {
    ...
    if (callDetailName != "") {
      ...
      // @ts-ignore
      callInfo += "<br><br><h2>Requirements</h2><b>ISEE:</b> " + this.callSelected.ISEE + "<br><b>Total budget:</b> " + this.callSelected.budget + "<br><b>Credits per year:</b> " + this.callSelected.credits + "<br><b>Funds per students' status:</b> " + this.callSelected.funds + "<br>";
